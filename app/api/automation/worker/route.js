...
export async function POST(request) {
  ...
  try {
    ...
    const result = await executeWorkflow(workflow.draft_definition, { workspaceId: job.workspace_id, input: job.payload.input || {}, onNodeEvent: (event) => writeNodeEvent({ workspaceId: job.workspace_id, executionId: job.execution_id, event }) });
